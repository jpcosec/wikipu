...
from kgdb.graph import add_knowledge_node, save_graph
    ...
    add_knowledge_node(
        ...
        KnowledgeNode(
            identity=SystemIdentity(
                node_id="doc:wiki/descendant.md", node_type="concept"
            )
        ),
    )

    graph.add_edge(
        "doc:wiki/ancestor.md", "doc:wiki/seed.md", relation_type="depends_on"
    )
    graph.add_edge(
        "doc:wiki/seed.md", "doc:wiki/descendant.md", relation_type="depends_on"
    )
