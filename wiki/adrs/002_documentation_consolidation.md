...
2. **Refine Spanish Drafts:** Incorporate relevant laws from `raw/sourcetalk_artifacts/00_hausordnung_draft.md` into `wiki/standards/00_house_rules.md`.
...
4. **Librarian canonical home:** The Librarian Agent's canonical protocol is `agents/librarian/intro.md`, which points to `wiki/standards/00_house_rules.md`.
