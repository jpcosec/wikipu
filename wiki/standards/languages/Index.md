...
Per-language style guides that translate the language-agnostic CS-1 through CS-9 rules from `wiki/standards/00_house_rules.md` (Layer 5) into each language's idioms, toolchain, and enforcement mechanisms. Every guide covers rule mapping, recommended toolchain configuration, and a breakdown of automated versus manual enforcement.
