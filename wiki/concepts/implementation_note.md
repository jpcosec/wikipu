---
identity:
  node_id: doc:wiki/concepts/implementation_note.md
  node_type: concept
edges:
...
source:
  ...
  compiled_at: '2026-04-14T16:50:28.660277'
...
`GitFacet` is populated during `build_wiki()` by calling `git log` and `git hash-object` per file.
