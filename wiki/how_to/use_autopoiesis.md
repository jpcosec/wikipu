...
- Familiarity with OP-8 in `wiki/standards/00_house_rules.md` — the eight-step cycle definition.
...
5. Put the current system's own state back into `raw/` as ore: export or copy the current `wiki/` content, `00_house_rules.md`, and relevant agent protocol descriptions as raw seed files.
...
7. Write a new version of `00_house_rules.md` incorporating what the cycle revealed: rules that caused friction should be tightened or removed; gaps in enforcement should be closed.
...
- [ ] `00_house_rules.md` has been revised to reflect what the cycle revealed — it is not identical to the pre-cycle version.
