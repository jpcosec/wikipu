...
- Access to `src/wiki_compiler/contracts.py` where the `Edge.relation_type` Literal is defined.
...
1. **Update Contracts:** Add the new relation string to the `Edge.relation_type` Literal in `src/wiki_compiler/contracts.py`.
